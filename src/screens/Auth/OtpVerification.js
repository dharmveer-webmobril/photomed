...
const OtpVerification = (props) => {
  ...
  const [requestCodeMutation, { isLoading: loading }] =
    useRequestCodeMutation();
    ...
    try {
      ...
      if (response.data?.succeeded) {
        ...
        if (preScreen == ScreenName.SIGN_UP) {
          ...
          navigate(ScreenName.UPDATE_PASSWORD, {
            token: response.data.ResponseBody.token,
          });
        }
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={commonStyles.authSbTitleStyle}>
        ...
        <Text
          style={[
            commonStyles.authSbTitleStyle,
            { alignSelf: "flex-end", marginRight: 28, marginTop: 10 },
          ]}
        >
        ...
        <CustomBtn
          ...
          title={"Verify Code"}
          btnStyle={{ marginTop: verticalScale(130), width: "85%" }}
        />
      </KeyboardAwareScrollView>
    </WrapperContainer>
  );
